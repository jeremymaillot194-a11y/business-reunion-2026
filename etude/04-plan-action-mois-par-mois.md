# 4. Plan d'action mois par mois (M1 → M36)

> Convention : **Lui** = porteur principal (disponible), **Elle** = appui en activité accessoire (2-3 h/soir max + week-ends, salaire conservé). Chaque mois liste : administratif, actions business, actions IA, objectif chiffré de sortie.

## Phase 0 — Avant tout (semaine 1-2)

1. **Vérifications juridiques bloquantes** :
   - Lui : vérifier l'éligibilité au titre de psychologue (M2 + stage pro) et, si oui, s'enregistrer (ADELI/RPPS via l'ARS La Réunion). Sinon, positionnement « prévention/bien-être » sans titre.
   - Elle : lire sa situation de cumul (contractuelle territoriale). **Aucune immatriculation à son nom avant autorisation écrite** de sa collectivité. Au départ : elle n'apparaît nulle part officiellement.
2. **Trésorerie** : ouvrir un compte dédié, y déposer les 15 000 €, règle des enveloppes du fichier 03.
3. **Rendez-vous aides** (gratuits) : CCI Réunion ou CMA, ADIE, Initiative Réunion. Si Lui a moins de 31 ans : dossier **TAJ** immédiatement (jusqu'à 8 000 €). S'il est inscrit à France Travail : **ADEN** (prêt 0 %, 8 000 €) + **ACRE**.
...
- **Agence** : 12-15 clients. Embarquer Elle sur l'onboarding/facturation **si l'autorisation de cumul est obtenue** ; sinon Lui automatise davantage.
- **Musique** : 1-2 prestations live/mois. Single 2. Analyse IA des contenus : doubler ce qui marche, tuer le reste.
- **E-commerce (préparation)** : shortlist de 10 producteurs péi (vanille, épices, tisanes), visites le week-end en couple, négociation prix/exclusivités de coffrets.
- **✅ Sortie M5** : 2 500 €/mois récurrents, 2 singles, 3 producteurs signés.
...
- Achat stock (6 500 € + marges accumulées), packaging, premières 200 expéditions depuis le salon (Colissimo outre-mer). Service client automatisé jour 1.
- **Musique** : single 3 + clip IA. Candidatures aux programmations locales (fêtes municipales, hôtels : haute saison à venir).
- **✅ Sortie M9** : 100 premières commandes livrées, note moyenne > 4,7/5.

### Mois 10-12 — Pic de Noël
...
- **T1** : revue stratégique : chaque moteur garde son budget SEULEMENT s'il a atteint 70 % de son objectif. Passage de Lui en EURL/SASU si CA > seuils micro (~77,7 k€ services / 188,7 k€ ventes) — arbitrage avec expert-comptable (~1 200 €/an, désormais rentable). Prêt d'honneur Initiative Réunion (3-25 k€) pour financer le stock de croissance de Lokal.re.
- **T2** : agence : recrutement d'un(e) alternant(e) ou VA à distance (10-15 h/sem.) piloté par les checklists IA. Lokal.re : box abonnement trimestrielle (lisse la saisonnalité). Musique : EP 5 titres, tournée des hôtels de la côte ouest.
...
| Moteur | KPI hebdo | Seuil d'alerte |
|---|---|---|
| Agence | MRR (revenu mensuel récurrent), churn | churn > 5 %/mois |
| Lokal.re | Commandes, coût d'acquisition, marge après pub | CAC > 30 % du panier |
| Musique | Abonnés nets, cachets signés, écoutes | 2 mois sans cachet |
| Infoproduits | E-mails captés, taux d'ouverture | < 100 e-mails/mois |
| Foyer | Trésorerie, réserve intacte ? | réserve < 2 000 € |

## Les 5 erreurs qui tueraient le plan (à relire chaque mois)

1. Lancer les 3 moteurs le même mois (→ le plan les échelonne M1 / M2 / M8).
2. Acheter du stock sans précommandes (→ règle des 50).
3. Immatriculer Madame sans autorisation de cumul (→ risque disciplinaire réel).
4. Croire que le streaming paiera avant 24 mois (→ le live paie, le streaming construit).
5. Toucher à la réserve de 2 800 € pour « une opportunité » (→ elle n'existe que pour les coups durs).
